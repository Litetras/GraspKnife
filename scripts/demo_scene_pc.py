...
#python scripts/demo_scene_pc.py --sample_data_dir /models/sample_data/real_scene_pc --gripper_config /models/checkpoints/graspgen_robotiq_2f_140.yml
...
def parse_args():
    ...
    parser.add_argument(
        "--sample_data_dir",
        type=str,
        default="/home/zyp/GraspGen/models/sample_data/real_scene_pc",
