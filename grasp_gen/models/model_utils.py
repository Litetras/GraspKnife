...
#生成器是一个条件扩散模型，以物体点云为条件，通过 DDPM 逆扩散过程生成 6-DOF 抓取姿态（4×4 齐次变换矩阵）。
...
#     pointnet：PointNetPlusPlus，含 3 层 Set Abstraction (SA) 模块，逐步降采样到 256、64 点，最终通过 MLP 输出固定维度的特征向量（默认 512 维） 
