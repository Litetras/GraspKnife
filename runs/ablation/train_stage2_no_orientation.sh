...
export STAGE1_DIS_CHECKPOINT="${STAGE1_DIS_CHECKPOINT:-/results/tutorial/logs/ablation_stage1_no_orientation_dis/last.pth}"
export DIS_LOG_DIR="${DIS_LOG_DIR:-/results/tutorial/logs/ablation_stage2_no_orientation_dis}"
